...
public class HttpOutputChannel extends Thread {
    ...
    private boolean initHttpClient() {
        try {
            if (httpClient == null) {
                ...
                LOG.info("initHttpAsyncClient:url:{}",
                        Arrays.asList(httpHosts));
                ...
                connectionManager.setMaxTotal(context.getMaxConnect());
                connectionManager.setDefaultMaxPerRoute(context.getMaxConnectPerRoute());
    ...
    public void send() throws InterruptedException {
        ...
        try {
            ...
            // send
            httpClient.execute(httpRequest.getRequest(), new HttpRequestCallback(context, httpRequest));
